...
public class RobotStatus extends AbstractRobotStatus {
	...
	@Override
	public void update() {
		if (!fSharedInputValues.getBoolean("ipb_robot_has_been_zeroed") && fSharedInputValues.getBoolean("ipb_collector_has_been_zeroed") && fSharedInputValues.getBoolean("ipb_hopper_has_been_zeroed")) {
